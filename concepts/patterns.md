...
The Intention/Actor pattern separates **what (Intention)** from **how (Actor)** in a motion system. This separation makes it possible for Runtimes to offload operations to separate threads or processes.
