...
**Interpreting events**: Input events received by gesture recognizers are transformed into meaningful outputs. These outputs are often some form of a transformation.
