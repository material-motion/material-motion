...
If each Plan has its own executor, each executor would end up creating its own interpretation of the velocity. The net result would be a confusing physical simulation.
