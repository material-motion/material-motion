...
The purpose of a Runtime is to fulfill Plans of rich, interactive motion. A Runtime is an implementation of the [Plan/Fulfillment](patterns/plan-fulfillment.md) pattern.
