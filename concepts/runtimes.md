...
If every instance of a Plan has its own executor, then velocity state would be created multiple times. Forces would be applied regardless of other Plans. The net result would be a confusing physical simulation.
