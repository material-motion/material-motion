...
The purpose of a Runtime is to receive **coordinated** plans of rich, interactive motion. A Runtime is an implementation of the [Plan/Fulfillment](patterns/plan-fulfillment.md) pattern. A [Coordinator](patterns/coordinator-plan.md) makes direct use of a Runtime.
