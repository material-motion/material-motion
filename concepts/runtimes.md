...
A unique executor can have at **most** one instance for a given target. Every Plan registered to the target that can be fulfilled by this executor type will be provided to the unique instance.
