...
📝 Many stream operators spec'd out.

## Android platform

🎉 `springSource` for Rebound landed.

🎉 Spring support for arbitrary types landed.

🎉 ReactiveProperty landed.

## Apple platforms

🎉 Landed an example of direct manipulation using the new Interactions APIs.

📝 Exploring L2 APIs.

📝 Exploring improvements to the stream source pattern.

## Web frameworks

🎉 `springSource` for [Rebound](https://github.com/facebook/rebound-js/) landed

📝 Starting work on Bottom Sheet interaction
...
| [streams-android](https://github.com/material-motion/streams-android/) | passing | [-81%-]{+44%+} | v1.0.0 | [-6-]{+13+} open |
...
| [streams-swift](https://github.com/material-motion/material-motion-swift) | passing | [-20%-]{+13%+} |  |  |  | [-0-]{+2+} open |
...
| [material-motion-js](https://github.com/material-motion/material-motion-js) | passing |  |  | [-57-]{+39+} open |
...
| [material-motion](https://github.com/material-motion/material-motion/) |  |  |  | [-16-]{+37+} open |
| [milemarker](https://github.com/material-motion/milemarker/) |  |  |  | 18 open |
| [sprints](https://github.com/material-motion/sprints/) |  |  |  | 32 open |
| [starmap](https://github.com/material-motion/starmap/) |  |  |  | [-45-]{+48+} open |
| [sublime](https://github.com/material-motion/sublime/) |  |  |  | [-4-]{+5+} open |
| [tools](https://github.com/material-motion/tools/) |  |  |  | [-97-]{+100+} open |
