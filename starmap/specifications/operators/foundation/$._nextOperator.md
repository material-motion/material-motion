...
availability:
  ...
  - platform:
    ...
    tests_url: https://github.com/material-motion/material-motion-js/blob/develop/packages/core/src/observables/__tests__/motionObservable-nextOperator.test.ts
interaction:
  inputs:
    - input:
      name: upstream
