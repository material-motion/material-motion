...
{% em type="red" %}Emphasis: recall from [Plan/Fulfillment](../concepts/plan-fulfillment.md) that an Intention (the Plan) does not fulfill itself.{% endem %} The Runtime will determine how to fulfill an Intention.
