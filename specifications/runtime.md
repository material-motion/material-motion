...
{% em type="red" %}Emphasis: recall from [Plan/Fulfillment](../concepts/plan-fulfillment.md) that Plan must not fulfill themselves.{% endem %} The Runtime will determine how to fulfill its provided Intentions.
