...
Let's zoom in to the Runtime for a moment. Core Animation is just another form of the plan/execution separation. Our Runtime has interpreted the "fadeIn" intention as being executable by Core Animation. The Runtime has delegated its execution to another system (a common pattern we'll make great use of).
